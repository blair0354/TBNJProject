...
<title><%=session.getAttribute("com_title")%>-公有土地歸戶資料查詢</title>
</head>
	...
	<input type="hidden" id="unit" name="unit" value="<%=obj.getUnit()%>">
		<table border="0" width=637 cellspacing="0" cellpadding="0">
			<tr align="center" valign="middle">
				<td colspan="2"><font size="4" face="標楷體" color="#FF9900">公有土地歸戶分類統計表
				</font>
			...
			<tr>
				...
				<td width="243" align="center" bgcolor="#FF00FF"><font
					color="#FFFFFF">公有土地歸戶分類統計表</font></td>
			</tr>
			<tr>
				<td>鄉鎮： 
