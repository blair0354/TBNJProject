...
<jsp:useBean id="obj" scope="request" class="lca.ap.LCAAP110F">
...
<table border="0" width=660 cellspacing="0" cellpadding="0">
	<tr align="center" valign="middle">
		<td colspan="3"><font size="4" face="標楷體" color="#FF9900">勞保局土地歸戶清冊</font>
	...
	<tr>
		<td colspan="3">報表格式：  <input	name="print_type" type="radio" value="2">PDF&nbsp;&nbsp;
