...
<jsp:useBean id="obj" scope="request" class="lca.ap.LCAAP130F">
...
<table border="0" width=660 cellspacing="0" cellpadding="0">
	<tr align="center" valign="middle">
		<td colspan="3"><font size="4" face="標楷體" color="#FF9900">批次歸戶</font>
	...
	<tr>
		...
		<%}%>
		<td width="160" align="center" bgcolor="#FF00FF"><font
			color="#FFFFFF">批次歸戶清冊</font></td>
	</tr>
	<tr>
	...
	<tr>
        ...
        <td colspan="2">
		<input name="optsel1" type="checkbox"  value="0">土地所有權&nbsp;<!-- 呼叫LCAAP030F-->
		<input name="optsel1" type="checkbox"  value="1">建物所有權&nbsp; <!--呼叫LCAAP040F-->
		<input name="optsel1" type="checkbox"  value="2">土地他項&nbsp;<!--呼叫LCAAP070F-->
		<input name="optsel1" type="checkbox"  value="3">建物他項&nbsp;<!--呼叫LCAAP080F-->
		<input name="optsel1" type="checkbox"  value="4">土地管理者&nbsp; <!--呼叫LCAAP050F-->
		<input name="optsel1" type="checkbox"  value="5">建物管理者&nbsp;<br><!--呼叫LCAAP060F-->
		<input name="optsel1" type="checkbox"  value="6">土地他項管理者&nbsp; <!--呼叫LCAAP090F-->
		<input name="optsel1" type="checkbox"  value="7">建物他項管理者&nbsp;<!--呼叫  LCAAP100F--> 
		<input name="optsel1" type="checkbox"  value="8" onclick='clickAll();'>全選/取消全選</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td colspan="3">
	...
	<tr>
		<td colspan="3">收件年字號： <input name="txtrcv_yr" maxlength="3"	size="4" value="<%=obj.getTxtrcv_yr()%>">&nbsp;年&nbsp; 
		<input name="txtrcv_word"	maxlength="10" size="10" value="<%=obj.getTxtrcv_word() %>">&nbsp;字第&nbsp; 
		<input name="txtrcv_no" maxlength="6" size="6">&nbsp;號</td>
	</tr>
	<tr>
		<td colspan="3">申請人統一編號： <input name="txtsno" maxlength="10"size="10"> 
		申請人姓名：<input name="txtsname" maxlength="30"	size="30"></td>
	</tr>
	<tr>
		<td colspan="3">代理人統一編號： <input name="txtsno1" maxlength="10" size="10"> 
		代理人姓名：<input name="txtsname1" maxlength="30" 	size="30"></td>
	</tr>
    <tr>
        <td colspan="3">
            申請對象：
	...
	<tr>
		<td colspan="3">申請用途： <input name="txtqry_purpose01"	type="checkbox" value="1">
		申辦登記案件使用&nbsp;&nbsp; <input name="txtqry_purpose02" type="checkbox" value="1">處理訴訟案件&nbsp;&nbsp;
		<input name="txtqry_purpose03" type="checkbox" value="1">其他 <input	name="txtqry_purpose03a" maxlength="30" size="30"></td>
	</tr>
	<tr>
		<td colspan="3">報表格式： <input name="print_type" type="radio" value="1" checked>EXCEL&nbsp;&nbsp; 
