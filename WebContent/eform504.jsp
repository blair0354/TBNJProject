...
<jsp:useBean id="obj" scope="request" class="lca.ap.EFORM504">
...
<table border="0" width="700" cellspacing="0" cellpadding="0">
	<tr align="center">
		<td colspan="3"><font size="4" face="標楷體" color="#FF9900">非都農業用地性別統計(產製作業)</font>
		<hr size="1" color="#008000" width="700" align="left">
		</td>
	</tr>
	<tr align="center">
		<td colspan="2">
			<input class="toolbar_default" type="button" name="btn_doProcess" value="產製非都農業用地性別統計資料" onClick="doProcess();">
			&nbsp;&nbsp;&nbsp;&nbsp;
