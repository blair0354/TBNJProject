...
String sql ="";
if((ma_lo!=null)&&(!ma_lo.equals(""))){	
	sql="select kcde_2,kcnt from ckeyn where kcde_1='46' and kcde_2<>'/*  */' and krmk='"+ma_lo+"'  order by kcde_2";
}else{
	sql="select kcde_2,kcnt from ckeyn where kcde_1='46' and kcde_2<>'/*  */' order by kcde_2";
}
