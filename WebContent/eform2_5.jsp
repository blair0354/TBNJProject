...
<title><%=session.getAttribute("com_title")%>-權利人姓名統編清冊</title>
</HEAD>
<script language="javascript">
	...
	function checkSubmit()
	{
		...
		var url = "eform2_5qry.jsp"
			+ "?txtcity_no=" + $("#txtcity_no").val()
			+ "&txtunit=" + $("#txtunit").val()
			+ "&txtqry_no=" + $("#txtqry_no").val()
			+ "&txtqry_name=" + $("#txtqry_name").val()
			+ "&txtrcv_yr=" + $("#txtrcv_yr").val()
			+ "&txtrcv_word=" + $("#txtrcv_word").val()
			+ "&txtrcv_no=" + $("#txtrcv_no").val()
			+ "&txtsno=" + $("#txtsno").val()
			+ "&txtsname=" + $("#txtsname").val()
			+ "&txtsno1=" + $("#txtsno1").val()
			+ "&txtsname1=" + $("#txtsname1").val()
			+ "&txtqry_purpose01=" + $("#txtqry_purpose01").val()
			+ "&txtqry_purpose02=" + $("#txtqry_purpose02").val()
			+ "&txtqry_purpose03=" + $("#txtqry_purpose03").val()
			+ "&txtqry_purpose03a=" + $("#txtqry_purpose03a").val()
			+ "&txtqry_oper=" + $("#txtqry_oper").val()
			;
		<%--
		$.ajax({
			type: "post",
	...
	<FORM Method="post" name="form1" onsubmit="return checkSubmit();">
		...
		<table border="0" width=630 cellspacing="0" cellpadding="0">
			<tr align="center" valign="middle">
				<td colspan="3"><font size="4" face="標楷體" color="#FF9900">權利人姓名統編清冊</font>
			...
			<tr>
				...
				<td width="150" align="center" bgcolor="#FF00FF"><font
					color="#FFFFFF">權利人姓名統一編號清冊</font></td>
			</tr>
			<tr>
				...
				<td align="center"><font color="#333333" size="2"> <input
						type=button value="製表" class=Button onClick="javascript:checkSubmit();"
			...
			<tr>
				...
				<input name="txtsno1" id="txtsno1" maxlength="10"
					size="10"> 代理人姓名：
				<input name="txtsname1" id="txtsname1" maxlength="30"
					size="30">
				</td>
			</tr>
			<tr>
