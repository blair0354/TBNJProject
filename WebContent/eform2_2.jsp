...
<table border="0" width=660 cellspacing="0" cellpadding="0">
	<tr align="center" valign="middle">
		<td colspan="3"><font size="4" face="標楷體" color="#FF9900">權利人歸戶清冊</font>
	...
	<tr>
		<td colspan="2"><input name="optsel1" type="radio" value="0"
			checked>土地歸戶&nbsp; <input name="optsel1" type="radio"
			value="1">建物歸戶&nbsp; <input name="optsel1" type="radio"
			value="2">他項權利歸戶&nbsp; <input name="optsel1" type="radio"
			value="3">全部</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
