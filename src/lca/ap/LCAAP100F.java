...
public class LCAAP100F extends QueryBean {
    ...
    public DefaultTableModel getResultModel() throws Exception {
        ...
        Common.insertDL_LOG(qry_seq, "I", this.getUserID(), this.getUnitID(),
            ...
            if (ownerV.size() > 0) {
                for (int i = 0; i < ownerV.size(); i++) {
                    ...
                    ResultSet rs = db.querySQL(sqlstr);
                     System.out.println("sqlstr===eform4_10==>"+sqlstr);
                    while (rs.next()) {
                        String sqlstr01 = "select cty,unit,cc00,cc48,cc49,cc01,cc09,cc15_1,cc15_2,cc15_3,cc15_4,cc18_1,cc18_2,cc18_3,cc27,cc24 ";
                        sqlstr01 += " from rclor where 1=1";
                        sqlstr01 += " and cc01="
                        ...
                        sqlstr01 += " and cc00='F'";
                        sqlstr01 += " order by cty,unit,cc48,cc49";
                        ResultSet rs01 = db.querySQL(sqlstr01);
                        System.out.println("sqlstr01===eform4_10==>"+sqlstr01);
                        while (rs01.next()) {
                            Vector data = new Vector();
                            String sqlstr02 = "select dd45,dd46,dd48,dd49,dd08,dd09,cty,unit";
                            sqlstr02 += " from rdbid where dd48="
                                    + Common.sqlChar(rs01.getString("cc48"));
                            sqlstr02 += " and dd49="
                                    + Common.sqlChar(rs01.getString("cc49"));
                            sqlstr02 += " and cty="
                            ...
                            System.out.println("sqlstr02===eform4_10==>"+sqlstr02);
                            while (rs02.next()) {
                                ...
                                String ch_cc48 = db
                                        .getLookupField("select kcnt from rkeyn where kcde_1='48' and kcde_2="
                                                ...
                                                + Common.sqlChar(rs01
                                                        .getString("unit")));
                                data.add(Common.isoToMS950(ch_cc48));
                                data.add(rs01.getString("cc49").substring(0, 5)
                                        + "-"
                                        + rs01.getString("cc49").substring(5));
                                data.add(Common.isoToMS950(rs02
                                        .getString("dd09")));
                                data.add(Common.areaFormat(rs02
                                        .getString("dd08")));
                                data.add(Common.get(rs01.getString("cc01"))
                                        .substring(0, 4)
                                        + "-"
                                        + Common.get(rs01.getString("cc01"))
                                                .substring(4));
                                String ch_cc09 = db
                                        .getLookupField("select lnam from rlnid where lidn="
                                                ...
                                                + Common.sqlChar(rs01
                                                        .getString("unit")));
                                data.add(Common.isoToMS950(ch_cc09));
                                String cht_cc27 = db
                                        .getLookupField("select kcnt from rkeyn where kcde_1='27' and kcde_2="
                                                ...
                                                + Common.sqlChar(rs01
                                                        .getString("unit")));
                                data.add(Common.isoToMS950(cht_cc27));
                                if (Common.get(rs01.getString("cc18_1"))
                                        .equals("")) {
                                    data.add(rs01.getString("cc18_2") + " 分之 "
                                            + rs01.getString("cc18_3"));
                                } else {
                                    String cht_cc18 = db
                                    ...
                                    data.add(Common.isoToMS950(cht_cc18)
                                            + rs01.getString("cc18_2") + " 分之 "
                                            + rs01.getString("cc18_3"));
                                }
                                data.add(Common.isoToMS950(Common.get(rs01
                                        .getString("cc24"))));
                            }
                          ...
                          //106年增修-20170421-blair:增加基地坐落
                            data.add(getRHD10List(rs.getString("mm48"),rs.getString("mm49"),ownerdata[3],ownerdata[4])[1]);
                ...
                for (int i = 0; i < ownerV.size(); i++) {
                    ...
                    while (rs.next()) {
                        ...
                        while (rs01.next()) {
                            ...
                            while (rs02.next()) {
                                ...
                                String cht_cc27 = db
                                        .getLookupField("select kcnt from rkeyn where kcde_1='27' and kcde_2="
                                                ...
                                                + Common.sqlChar(rs01
                                                        .getString("unit")));
                                data.add(Common.get(rs01.getString("cc27")));
                                data.add(Common.isoToMS950(cht_cc27));
                                if (Common.get(rs01.getString("cc18_1"))
                                        .equals("")) {
                                    data.add("");
                                    data.add("");
                                    data.add(Common.get(rs01
                                            .getString("cc18_2")));
                                    data.add(Common.get(rs01
                                            .getString("cc18_3")));
                                } else {
                          ...
                          //106年增修-20170421-blair:增加基地坐落
                            String[] arryRHD10=getRHD10List(rs.getString("mm48"),rs.getString("mm49"),ownerdata[3],ownerdata[4]);
    ...
    public Vector queryOwner() throws Exception {
        ...
        qry_seq = "I" + qry_date_start + qry_time_start;
        this.setQry_seq(qry_seq);
        con = "地籍總歸戶清冊(建物他項權利人管理者)";
    ...
    public String[] getRHD10List(String HD48,String HD49,String CTY,String UNIT) throws Exception {
        ...
        try {
        	String sql = " select a.HA48,a.HA49 ,b.kcnt,substr(a.HA49,1,4)||'-'||substr(a.HA49,5,4)as HA49C "
        		...
        		+ "";
        	System.out.println("RHD10=======eform4_10=======>"+sql);
