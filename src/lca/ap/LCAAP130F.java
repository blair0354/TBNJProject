...
public class LCAAP130F extends QueryBean {
                    ...
                    if ((this.getOptsel1().equals("0"))
                        ...
                        while (rs.next()) {
                            ...
                            while (rs01.next()) {
                                ...
                                data.add(rs.getString("bb15_2") + " 分之 "
                                        + rs.getString("bb15_3"));
                            }
                            rowData.add(data);
                    ...
                    if ((this.getOptsel1().equals("2"))
                        ...
                        while (rs.next()) {
                            ...
                            while (rs01.next()) {
                                ...
                                data.add(rs.getString("cc18_2") + " 分之 "+ rs.getString("cc18_3"));
                            }
                            rowData.add(data);
                            rs01.getStatement().close();
                            rs01.close();
                    ...
                    if ((this.getOptsel1().equals("1"))
                        ...
                        while (rs.next()) {
                            ...
                            while (rs01.next()) {
                                ...
                                data.add(rs.getString("ee15_2") + " 分之 "
                                        + rs.getString("ee15_3"));
                            }
                            rowData.add(data);
                            rs01.getStatement().close();
    ...
    public void genReport() throws Exception {
        for(String s : getOptsel1()){
            if(s.equals("0")){
                LCAAP030F obj0 = new LCAAP030F();
                obj0.setFds(fds);
                obj0.setUserID(getUserID());
                obj0.setUnitID(getUnitID());
                obj0.setPrint_type(getPrint_type());
                obj0.setContext(getContext());
                obj0.setReportLocation(getReportLocation());
                obj0.setTxtqry_usertype(getTxtqry_usertype());
                obj0.setTxtqry_purpose01(getTxtqry_purpose01());
                obj0.setTxtqry_purpose02(getTxtqry_purpose02());
                obj0.setTxtqry_purpose03(getTxtqry_purpose03());
                obj0.setTxtqry_purpose03a(getTxtqry_purpose03a());
                obj0.setTxtrcv_yr(getTxtrcv_yr());
                obj0.setTxtrcv_word(getTxtrcv_word());
                obj0.setTxtrcv_no(getTxtrcv_no());
                obj0.setTxtsno(getTxtsno());
                obj0.setTxtsname(getTxtsname());
                obj0.setTxtsno1(getTxtsno1());
                obj0.setTxtsname1(getTxtsname1());
                obj0.setTxtqry_oper(getTxtqry_oper());
                obj0.genReport();
            }// 呼叫LCAAP030F
            if(s.equals("1")){
                LCAAP040F obj1 = new LCAAP040F();
                obj1.setFds(fds);
                obj1.setUserID(getUserID());
                obj1.setUnitID(getUnitID());
                obj1.setPrint_type(getPrint_type());
                obj1.setContext(getContext());
                obj1.setReportLocation(getReportLocation());
                obj1.setTxtqry_usertype(getTxtqry_usertype());
                obj1.setTxtqry_purpose01(getTxtqry_purpose01());
                obj1.setTxtqry_purpose02(getTxtqry_purpose02());
                obj1.setTxtqry_purpose03(getTxtqry_purpose03());
                obj1.setTxtqry_purpose03a(getTxtqry_purpose03a());
                obj1.setTxtrcv_yr(getTxtrcv_yr());
                obj1.setTxtrcv_word(getTxtrcv_word());
                obj1.setTxtrcv_no(getTxtrcv_no());
                obj1.setTxtsno(getTxtsno());
                obj1.setTxtsname(getTxtsname());
                obj1.setTxtsno1(getTxtsno1());
                obj1.setTxtsname1(getTxtsname1());
                obj1.setTxtqry_oper(getTxtqry_oper());
                obj1.genReport();
            }// 呼叫LCAAP040F
            if(s.equals("2")){
                LCAAP070F obj2 = new LCAAP070F();
                obj2.setFds(fds);
                obj2.setUserID(getUserID());
                obj2.setUnitID(getUnitID());
                obj2.setPrint_type(getPrint_type());
                obj2.setContext(getContext());
                obj2.setReportLocation(getReportLocation());
                obj2.setTxtqry_usertype(getTxtqry_usertype());
                obj2.setTxtqry_purpose01(getTxtqry_purpose01());
                obj2.setTxtqry_purpose02(getTxtqry_purpose02());
                obj2.setTxtqry_purpose03(getTxtqry_purpose03());
                obj2.setTxtqry_purpose03a(getTxtqry_purpose03a());
                obj2.setTxtrcv_yr(getTxtrcv_yr());
                obj2.setTxtrcv_word(getTxtrcv_word());
                obj2.setTxtrcv_no(getTxtrcv_no());
                obj2.setTxtsno(getTxtsno());
                obj2.setTxtsname(getTxtsname());
                obj2.setTxtsno1(getTxtsno1());
                obj2.setTxtsname1(getTxtsname1());
                obj2.setTxtqry_oper(getTxtqry_oper());
               obj2.genReport();
            }// 呼叫LCAAP070F
            if(s.equals("3")){
                LCAAP080F obj3 = new LCAAP080F();
                obj3.setFds(fds);
                obj3.setUserID(getUserID());
                obj3.setUnitID(getUnitID());
                obj3.setPrint_type(getPrint_type());
                obj3.setContext(getContext());
                obj3.setReportLocation(getReportLocation());
                obj3.setTxtqry_usertype(getTxtqry_usertype());
                obj3.setTxtqry_purpose01(getTxtqry_purpose01());
                obj3.setTxtqry_purpose02(getTxtqry_purpose02());
                obj3.setTxtqry_purpose03(getTxtqry_purpose03());
                obj3.setTxtqry_purpose03a(getTxtqry_purpose03a());
                obj3.setTxtrcv_yr(getTxtrcv_yr());
                obj3.setTxtrcv_word(getTxtrcv_word());
                obj3.setTxtrcv_no(getTxtrcv_no());
                obj3.setTxtsno(getTxtsno());
                obj3.setTxtsname(getTxtsname());
                obj3.setTxtsno1(getTxtsno1());
                obj3.setTxtsname1(getTxtsname1());
                obj3.setTxtqry_oper(getTxtqry_oper());
                obj3.genReport();
            }// 呼叫LCAAP080F
            if(s.equals("4")){
                LCAAP050F obj4 = new LCAAP050F();
                obj4.setFds(fds);
                obj4.setUserID(getUserID());
                obj4.setUnitID(getUnitID());
                obj4.setPrint_type(getPrint_type());
                obj4.setContext(getContext());
                obj4.setReportLocation(getReportLocation());
                obj4.setTxtqry_usertype(getTxtqry_usertype());
                obj4.setTxtqry_purpose01(getTxtqry_purpose01());
                obj4.setTxtqry_purpose02(getTxtqry_purpose02());
                obj4.setTxtqry_purpose03(getTxtqry_purpose03());
                obj4.setTxtqry_purpose03a(getTxtqry_purpose03a());
                obj4.setTxtrcv_yr(getTxtrcv_yr());
                obj4.setTxtrcv_word(getTxtrcv_word());
                obj4.setTxtrcv_no(getTxtrcv_no());
                obj4.setTxtsno(getTxtsno());
                obj4.setTxtsname(getTxtsname());
                obj4.setTxtsno1(getTxtsno1());
                obj4.setTxtsname1(getTxtsname1());
                obj4.setTxtqry_oper(getTxtqry_oper());
                obj4.genReport();
            }// 呼叫LCAAP050F
            if(s.equals("5")){
                LCAAP060F obj5 = new LCAAP060F();
                obj5.setFds(fds);
                obj5.setUserID(getUserID());
                obj5.setUnitID(getUnitID());
                obj5.setPrint_type(getPrint_type());
                obj5.setContext(getContext());
                obj5.setReportLocation(getReportLocation());
                obj5.setTxtqry_usertype(getTxtqry_usertype());
                obj5.setTxtqry_purpose01(getTxtqry_purpose01());
                obj5.setTxtqry_purpose02(getTxtqry_purpose02());
                obj5.setTxtqry_purpose03(getTxtqry_purpose03());
                obj5.setTxtqry_purpose03a(getTxtqry_purpose03a());
                obj5.setTxtrcv_yr(getTxtrcv_yr());
                obj5.setTxtrcv_word(getTxtrcv_word());
                obj5.setTxtrcv_no(getTxtrcv_no());
                obj5.setTxtsno(getTxtsno());
                obj5.setTxtsname(getTxtsname());
                obj5.setTxtsno1(getTxtsno1());
                obj5.setTxtsname1(getTxtsname1());
                obj5.setTxtqry_oper(getTxtqry_oper());
                obj5.genReport();
            }// 呼叫LCAAP060F
            if(s.equals("6")){
                LCAAP090F obj6 = new LCAAP090F();
                obj6.setFds(fds);
                obj6.setUserID(getUserID());
                obj6.setUnitID(getUnitID());
                obj6.setPrint_type(getPrint_type());
                obj6.setContext(getContext());
                obj6.setReportLocation(getReportLocation());
                obj6.setTxtqry_usertype(getTxtqry_usertype());
                obj6.setTxtqry_purpose01(getTxtqry_purpose01());
                obj6.setTxtqry_purpose02(getTxtqry_purpose02());
                obj6.setTxtqry_purpose03(getTxtqry_purpose03());
                obj6.setTxtqry_purpose03a(getTxtqry_purpose03a());
                obj6.setTxtrcv_yr(getTxtrcv_yr());
                obj6.setTxtrcv_word(getTxtrcv_word());
                obj6.setTxtrcv_no(getTxtrcv_no());
                obj6.setTxtsno(getTxtsno());
                obj6.setTxtsname(getTxtsname());
                obj6.setTxtsno1(getTxtsno1());
                obj6.setTxtsname1(getTxtsname1());
                obj6.setTxtqry_oper(getTxtqry_oper());
                obj6.genReport();
            }// 呼叫LCAAP090F
            if(s.equals("7")){
                LCAAP100F obj7 = new LCAAP100F();
                obj7.setFds(fds);
                obj7.setUserID(getUserID());
                obj7.setUnitID(getUnitID());
                obj7.setPrint_type(getPrint_type());
                obj7.setContext(getContext());
                obj7.setReportLocation(getReportLocation());
                obj7.setTxtqry_usertype(getTxtqry_usertype());
                obj7.setTxtqry_purpose01(getTxtqry_purpose01());
                obj7.setTxtqry_purpose02(getTxtqry_purpose02());
                obj7.setTxtqry_purpose03(getTxtqry_purpose03());
                obj7.setTxtqry_purpose03a(getTxtqry_purpose03a());
                obj7.setTxtrcv_yr(getTxtrcv_yr());
                obj7.setTxtrcv_word(getTxtrcv_word());
                obj7.setTxtrcv_no(getTxtrcv_no());
                obj7.setTxtsno(getTxtsno());
                obj7.setTxtsname(getTxtsname());
                obj7.setTxtsno1(getTxtsno1());
                obj7.setTxtsname1(getTxtsname1());
                obj7.setTxtqry_oper(getTxtqry_oper());
                obj7.genReport();
            }// 呼叫 LCAAP100F
//            if (s.equals("8")) {
//                LCAAP030F obj0 = new LCAAP030F(); obj0.setFds(fds); obj0.setUserID(getUserID()); obj0.setUnitID(getUnitID());
//                    obj0.setPrint_type(getPrint_type()); obj0.setContext(getContext());obj0.setReportLocation(getReportLocation()); obj0.genReport();
//                LCAAP040F obj1 = new LCAAP040F(); obj1.setFds(fds); obj1.setUserID(getUserID()); obj1.setUnitID(getUnitID());
//                    obj1.setPrint_type(getPrint_type()); obj1.setContext(getContext());obj1.setReportLocation(getReportLocation()); obj1.genReport();
//                LCAAP070F obj2 = new LCAAP070F(); obj2.setFds(fds); obj2.setUserID(getUserID()); obj2.setUnitID(getUnitID());
//                    obj2.setPrint_type(getPrint_type()); obj2.setContext(getContext());obj2.setReportLocation(getReportLocation()); obj2.genReport();
//                LCAAP080F obj3 = new LCAAP080F(); obj3.setFds(fds); obj3.setUserID(getUserID()); obj3.setUnitID(getUnitID());
//                    obj3.setPrint_type(getPrint_type()); obj3.setContext(getContext());obj3.setReportLocation(getReportLocation()); obj3.genReport();
//                LCAAP050F obj4 = new LCAAP050F(); obj4.setFds(fds); obj4.setUserID(getUserID()); obj4.setUnitID(getUnitID());
//                    obj4.setPrint_type(getPrint_type()); obj4.setContext(getContext());obj4.setReportLocation(getReportLocation()); obj4.genReport();
//                LCAAP060F obj5 = new LCAAP060F(); obj5.setFds(fds); obj5.setUserID(getUserID()); obj5.setUnitID(getUnitID());
//                    obj5.setPrint_type(getPrint_type()); obj5.setContext(getContext());obj5.setReportLocation(getReportLocation()); obj5.genReport();
//                LCAAP090F obj6 = new LCAAP090F(); obj6.setFds(fds); obj6.setUserID(getUserID()); obj6.setUnitID(getUnitID());
//                    obj6.setPrint_type(getPrint_type()); obj6.setContext(getContext());obj6.setReportLocation(getReportLocation()); obj6.genReport();
//                LCAAP100F obj7 = new LCAAP100F(); obj7.setFds(fds); obj7.setUserID(getUserID()); obj7.setUnitID(getUnitID());
//                    obj7.setPrint_type(getPrint_type()); obj7.setContext(getContext());obj7.setReportLocation(getReportLocation()); obj7.genReport();
//            }
        }
    }
    ...
    public Vector queryOwner() throws Exception {
        ...
        qry_seq = "A" + qry_date_start + qry_time_start;this.setQry_seq(qry_seq);
        if (this.getOptsel1().equals("0")) { con = "批次歸戶：土地所有權歸戶";}//呼叫LCAAP030F
        if (this.getOptsel1().equals("1")) { con = "批次歸戶：建物所有權歸戶";}//呼叫LCAAP040F
        if (this.getOptsel1().equals("2")) { con = "批次歸戶：土地他項權利歸戶";}//呼叫LCAAP070F
        if (this.getOptsel1().equals("3")) { con = "批次歸戶：建物他項權利歸戶";}//呼叫LCAAP080F
        if (this.getOptsel1().equals("4")) { con = "批次歸戶：土地管理者歸戶";}//呼叫LCAAP050F
        if (this.getOptsel1().equals("5")) { con = "批次歸戶：建物管理者歸戶";}//呼叫LCAAP060F
        if (this.getOptsel1().equals("6")) { con = "批次歸戶：土地他項管理者歸戶";}//呼叫LCAAP090F
        if (this.getOptsel1().equals("7")) { con = "批次歸戶：建物他項管理者歸戶";}//呼叫  LCAAP100F
        if (this.getOptsel1().equals("8")) { con = "批次歸戶：全部";}
        qry = "市縣市=" + this.getTxtcity_no() + ";事務所=" + this.getTxtunit()
                + ";統一編號=" + this.getTxtqry_no() + ";姓名=" + this.getTxtqry_name();
        ...
        try {
            for (int j = 0; j < fds.length; j++) {
                ...
                if (str.length > 1) {
                    sql += " and  NVL(lnam,'X')=NVL(" + Common.sqlChar(str[1])
                            + ",'X')";
                ...
                if (str.length > 2) {
                    sql += " and  NVL(ladr,'X')=NVL(" + Common.sqlChar(str[2])
                            + ",'X')";
                } else {
                    sql += " and ladr is null";
                }
                if (str.length == 4) {
                    sql += " and lbir_2=NVL(" + Common.sqlChar(str[3])
                            + ",lbir_2)";
                } else {
