...
public class LCAAP090F extends QueryBean {
                    ...
                    while (rs.next()) {
                        ...
                        while (rs01.next()) {
                            ...
                            while (rs02.next()) {
                                ...
                                data.add(rs01.getString("cc49").substring(0, 4)
                                        + "-"
                                        + rs01.getString("cc49").substring(4));
    ...
    public Vector queryOwner() throws Exception {
        ...
        qry_seq = "H" + qry_date_start + qry_time_start;
        this.setQry_seq(qry_seq);
        con = "地籍總歸戶清冊(土地他項權利人管理者)";
