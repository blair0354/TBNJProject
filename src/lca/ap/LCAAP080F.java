...
public class LCAAP080F extends QueryBean {
    ...
    public DefaultTableModel getResultModel() throws Exception {
        ...
        Common.insertDL_LOG(qry_seq, "E", this.getUserID(), this.getUnitID(),
        ...
        try {
            ...
            for (int i = 0; i < ownerV.size(); i++) {
                ...
                System.out.println("second====eform4_8==>" + sqlstr);
                while (rs.next()) {
                    Vector data = new Vector();
                    String sqlstr01 = "";
                    sqlstr01 = "select dd45,dd46,dd48,dd49,dd08,dd09,cty,unit ";
                    ...
                    System.out.println("third==eform4_8_1==>" + sqlstr);
                    while (rs01.next()) {
                        ...
                        String ch_cc48 = db
                                .getLookupField("select kcnt from rkeyn where kcde_1='48' and kcde_2="
                                        + Common
                                                .sqlChar(rs01.getString("dd48"))
                                        + " and cty="
                                        + Common.sqlChar(rs.getString("cty"))
                                        + " and unit="
                                        + Common.sqlChar(rs.getString("unit")));
                        data.add(Common.isoToMS950(ch_cc48));
                        data.add(rs.getString("cc49").substring(0, 5) + "-"
                                + rs.getString("cc49").substring(5));
                        data.add(Common.isoToMS950(rs01.getString("dd09")));
                        data.add(Common.areaFormat(rs01.getString("dd08")));
                        ...
                        while (rs01.next()) {
                            ...
                            String ch_cty = db
                                    .getLookupField("select kcnt from rkeyn where kcde_1='45' and kcde_2="
                                            ...
                                            + Common.sqlChar(rs
                                                    .getString("unit")));
                            data.add(Common.get(rs01.getString("dd45")));
                            data.add(Common.isoToMS950(ch_cty));
                            String ch_dd46 = db
                                    .getLookupField("select kcnt from rkeyn where kcde_1='46' and kcde_2="
                                            + Common.sqlChar(rs01
                                            ...
                                            + Common.sqlChar(rs
                                                    .getString("unit")));
                            data.add(Common.get(rs01.getString("dd46")));
                            data.add(Common.isoToMS950(ch_dd46));
                            String ch_dd48 = db
                                    .getLookupField("select kcnt from rkeyn where kcde_1='48' and kcde_2="
                                            + Common.sqlChar(rs01
                                            ...
                                            + Common.sqlChar(rs
                                                    .getString("unit")));
                            data.add(Common.get(rs.getString("cc48")));
    ...
    public Vector queryOwner() throws Exception {
        ...
        qry_seq = "E" + qry_date_start + qry_time_start;
    ...
    public String[] getRHD10List(String HD48,String HD49,String CTY,String UNIT) throws Exception {
        ...
        try {
        	String sql = " select a.HA48,a.HA49 ,b.kcnt,substr(a.HA49,1,4)||'-'||substr(a.HA49,5,4)as HA49C "
        		...
        		+ "";
        	System.out.println("=====eform4_8_RHD10=====>"+sql);
