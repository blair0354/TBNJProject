...
public class LCAAP040F extends QueryBean {
    ...
    public DefaultTableModel getResultModel() throws Exception {
        ...
        Common.insertDL_LOG(qry_seq, "C", this.getUserID(), this.getUnitID(),
                ...
                for (int i = 0; i < ownerV.size(); i++) {
                    ...
                    while (rs.next()) {
                        ...
                        while (rs01.next()) {
                            ...
                            data.add(Common.get(Common.isoToMS950(rs01
                                    .getString("dd09"))));
                            data.add(Common.get(rs01.getString("dd08")));
                ...
                if (this.getPrint_type().equals("2")) {
                    ...
                    if (compare) {
                        Common.updateDL_LOG("4", vid + ":;:"
                                + this.getQry_seq() + ".pdf", Datetime
                                .getYYYMMDD(), Datetime.getHHMMSS(), this
                                .getQry_seq());
                    } else {
    ...
    public Vector queryOwner() throws Exception {
        ...
        qry_seq = "C" + qry_date_start + qry_time_start;
