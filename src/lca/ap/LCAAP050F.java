...
public class LCAAP050F extends QueryBean {
    ...
    public DefaultTableModel getResultModel() throws Exception {
        ...
        Common.insertDL_LOG(qry_seq, "F", this.getUserID(), this.getUnitID(),
        ...
        try {
            ...
            if (ownerV.size() > 0) {
                for (int i = 0; i < ownerV.size(); i++) {
                    ...
                    System.out.println("Query RMNGR START:"+Datetime.getYYYMMDD()+Datetime.getHHMMSS());
                    // System.out.println("sqlstr==>"+sqlstr);
                    while (rs.next()) {
                        System.out.println("LCAAP050 mm01:"+rs.getString("mm01")+" mm48:"+rs.getString("mm48")+" mm49:"+rs.getString("mm49")+" cty:"+rs.getString("cty")+" unit:"+rs.getString("unit"));
                        System.out.println("Query RBLOW START:"+Datetime.getYYYMMDD()+Datetime.getHHMMSS());
                        String sqlstr01 = "select cty,unit,ba48,ba49,bb01,bb09,bb15_1,bb15_2,bb15_3,bb21 ";
                        sqlstr01 += "from rblow where 1=1";
                        sqlstr01 += " and bb01="
                        ...
                        sqlstr01 += " order by cty,unit,ba48,ba49";
                        ResultSet rs01 = db.querySQL(sqlstr01);
                        // System.out.println("sqlstr01==>"+sqlstr01);
                        while (rs01.next()) {
                            System.out.println("Query RALID START:"+Datetime.getYYYMMDD()+Datetime.getHHMMSS());
                            Vector data = new Vector();
                            String sqlstr02 = "select aa45,aa46,aa48,aa49,aa10,aa11,aa12,aa16 ";
                            sqlstr02 += "from ralid where aa48="
                                    + Common.sqlChar(rs01.getString("ba48"));
                            sqlstr02 += " and aa49="
                                    + Common.sqlChar(rs01.getString("ba49"));
                            sqlstr02 += " and cty="
                                    + Common.sqlChar(rs01.getString("cty"));
                            sqlstr02 += " and unit="
                                    + Common.sqlChar(rs01.getString("unit"));
                            sqlstr02 += " order by aa48,aa49";
                            ResultSet rs02 = db.querySQL(sqlstr02);
                            // System.out.println("sqlstr02==>"+sqlstr02);
                            while (rs02.next()) {
                                data.add(ownerdata[0]);
                                data.add(ownerdata[1]);
                                data.add(Common.get(rs02.getString("aa45")));
                                String ch_cty = db
                                ...
                                data.add(Common.get(rs02.getString("aa46")));
                                String ch_aa46 = db
                                ...
                                data.add(Common.get(rs02.getString("aa48")));
                                String ch_aa48 = db
                                ...
                                String ch_bb09 = db
                                        .getLookupField("select lnam from rlnid where lidn="
                                                ...
                                                + Common.sqlChar(rs01
                                                        .getString("unit")));
                                data.add(Common.isoToMS950(ch_bb09));
                                data.add(Common.get(rs01.getString("bb01")));
                                if (Common.get(rs01.getString("bb15_1"))
                                        .equals("")) {
                                    data.add(rs01.getString("bb15_2") + " 分之 "
                                            + rs01.getString("bb15_3"));
                                } else {
                                    String cht_bb15 = db
                                ...
                                data.add(Common.valueFormat(rs02
                                        .getString("aa16")));
                                String cht_aa17 = db
                                        .getLookupField("select krmk from rkeyn where kcde_1='00' and kcde_2='V1' and cty="
                                                + Common.sqlChar(rs01
                                                        .getString("cty"))
                                                + " and unit="
                                                + Common.sqlChar(rs01
                                                        .getString("unit")));
                                data.add(cht_aa17);
                                data.add(Common.valueFormat(rs01
                                        .getString("bb21")));
                            }
                            rs02.getStatement().close();
                            rs02.close();
                            rowData.add(data);
                            System.out.println("Query RALID END:"+Datetime.getYYYMMDD()+Datetime.getHHMMSS());
                        }
                        rs01.getStatement().close();
                        rs01.close();
                        System.out.println("Query RBLOW END:"+Datetime.getYYYMMDD()+Datetime.getHHMMSS());
                    }
                    rs.getStatement().close();
                    rs.close();
                    System.out.println("Query RMMGR START:"+Datetime.getYYYMMDD()+Datetime.getHHMMSS());
                }
            }
            if (rowData.size() == 0) {
                Vector data = new Vector();
        ...
        try {
            ...
            if (ownerV.size() > 0) {
                for (int i = 0; i < ownerV.size(); i++) {
                    ...
                    sqlstr += " and unit=" + Common.sqlChar(ownerdata[4]);
                    sqlstr += " order by cty,unit,mm48,mm49,mm01";
                    System.out.println("LCAAP050F TXT rmngr START time="+Datetime.getYYYMMDD()+Datetime.getHHMMSS()+"  sql="+sqlstr);
                    ResultSet rs = db.querySQL(sqlstr);
                    // System.out.println("sqlstr==>"+sqlstr);
                    while (rs.next()) {
                        String sqlstr01 = "select cty,unit,ba48,ba49,bb01,bb09,bb15_1,bb15_2,bb15_3,bb21 ";
                        sqlstr01 += "from rblow where 1=1";
                        sqlstr01 += " and bb01=" + Common.sqlChar(rs.getString("mm01"));
                        sqlstr01 += " and ba48=" + Common.sqlChar(rs.getString("mm48"));
                        sqlstr01 += " and ba49=" + Common.sqlChar(rs.getString("mm49"));
                        sqlstr01 += " and cty=" + Common.sqlChar(rs.getString("cty"));
                        sqlstr01 += " and unit=" + Common.sqlChar(rs.getString("unit"));
                        sqlstr01 += " order by cty,unit,ba48,ba49";
                        System.out.println("LCAAP050F TXT rblow START time="+Datetime.getYYYMMDD()+Datetime.getHHMMSS()+"  sql="+sqlstr01);
                        ResultSet rs01 = db.querySQL(sqlstr01);
                        while (rs01.next()) {
                            Vector data = new Vector();
                            String sqlstr02 = "select aa45,aa46,aa48,aa49,aa10,aa11,aa12,aa16 ";
                            sqlstr02 += "from ralid where aa48=" + Common.sqlChar(rs01.getString("ba48"));
                            sqlstr02 += " and aa49=" + Common.sqlChar(rs01.getString("ba49"));
                            sqlstr02 += " and cty=" + Common.sqlChar(rs01.getString("cty"));
                            sqlstr02 += " and unit=" + Common.sqlChar(rs01.getString("unit"));
                            sqlstr02 += " order by aa48,aa49";
                            System.out.println("LCAAP050F TXT ralid START time="+Datetime.getYYYMMDD()+Datetime.getHHMMSS()+"  sql="+sqlstr02);
                            ResultSet rs02 = db.querySQL(sqlstr02);
                            while (rs02.next()) {
                                data.add(ownerdata[0]);
                                data.add(ownerdata[1]);
                                ...
                                String ch_cty = db.getLookupField("select kcnt from rkeyn where kcde_1='45' and kcde_2="
                                                + Common.sqlChar(rs02.getString("aa45"))
                                ...
                                String ch_aa46 = db.getLookupField("select kcnt from rkeyn where kcde_1='46' and kcde_2="
                                                + Common.sqlChar(rs02.getString("aa46"))
                                                + " and cty=" + Common.sqlChar(rs01.getString("cty"))
                                                + " and unit=" + Common.sqlChar(rs01.getString("unit")));
                                data.add(Common.isoToMS950(ch_aa46));
                                data.add(Common.get(rs02.getString("aa48")));
                                String ch_aa48 = db.getLookupField("select kcnt from rkeyn where kcde_1='48' and kcde_2="
                                                + Common.sqlChar(rs02.getString("aa48"))
                                                + " and cty=" + Common.sqlChar(rs01.getString("cty"))
                                                + " and unit=" + Common.sqlChar(rs01.getString("unit")));
                                data.add(Common.isoToMS950(ch_aa48));
                                data.add(rs01.getString("ba49"));
                                data.add(Common.get(rs02.getString("aa10")));
                                String ch_bb09 = db.getLookupField("select lnam from rlnid where lidn="
                                                + Common.sqlChar(rs01.getString("bb09"))
                                                + " and cty=" + Common.sqlChar(rs01.getString("cty"))
                                                + " and unit=" + Common.sqlChar(rs01.getString("unit")));
                                data.add(Common.isoToMS950(ch_bb09));
                                data.add(Common.get(rs01.getString("bb01")));
                                if (Common.get(rs01.getString("bb15_1")).equals("")) {
                                    data.add("");
                                    data.add("");
                                    data.add(Common.get(rs01.getString("bb15_2")));
                                    data.add(Common.get(rs01.getString("bb15_3")));
                                } else {
                                    String cht_bb15 = db.getLookupField("select kcnt from rkeyn where kcde_1='15' and kcde_2="
                                                    + Common.sqlChar(rs01.getString("bb15_1"))
                                                    + " and cty=" + Common.sqlChar(rs01.getString("cty"))
                                                    + " and unit=" + Common.sqlChar(rs01.getString("unit")));
                                    data.add(Common.get(rs01.getString("bb15_1")));
                                    data.add(Common.isoToMS950(cht_bb15));
                                    data.add(Common.get(rs01.getString("bb15_2")));
                                    data.add(Common.get(rs01.getString("bb15_3")));
                                }
                                String cht_aa11 = db.getLookupField("select kcnt from rkeyn where kcde_1='11' and kcde_2="
                                                + Common.sqlChar(rs02.getString("aa11"))
                                                + " and cty=" + Common.sqlChar(rs01.getString("cty"))
                                                + " and unit=" + Common.sqlChar(rs01.getString("unit")));
                                data.add(Common.get(rs02.getString("aa11")));
                                data.add(Common.isoToMS950(cht_aa11));
                                String cht_aa12 = db.getLookupField("select kcnt from rkeyn where kcde_1='12' and kcde_2="
                                                + Common.sqlChar(rs02.getString("aa12"))
                                                + " and cty=" + Common.sqlChar(rs01.getString("cty"))
                                                + " and unit=" + Common.sqlChar(rs01.getString("unit")));
                                data.add(Common.get(rs02.getString("aa12")));
                                data.add(Common.isoToMS950(cht_aa12));
                                data.add(Common.get(rs02.getString("aa16")));
                                String cht_aa17 = db.getLookupField("select krmk from rkeyn where kcde_1='00' and kcde_2='V1' and cty="
                                                + Common.sqlChar(rs01.getString("cty"))
                                                + " and unit=" + Common.sqlChar(rs01.getString("unit")));
                                data.add(cht_aa17);
                                data.add(Common.get(rs01.getString("bb21")));
                            }
                            rs02.getStatement().close();
                            rs02.close();
                            rowData.add(data);
                            System.out.println("LCAAP050F TXT ralid END time="+Datetime.getYYYMMDD()+Datetime.getHHMMSS());
                        }
                        rs01.getStatement().close();
                        rs01.close();
                        System.out.println("LCAAP050F TXT rblow END time="+Datetime.getYYYMMDD()+Datetime.getHHMMSS());
                    }
                    rs.getStatement().close();
                    rs.close();
                    System.out.println("LCAAP050F TXT rmngr END time="+Datetime.getYYYMMDD()+Datetime.getHHMMSS());
                }
            }
            if (rowData.size() == 0) {
                Vector data = new Vector();
    ...
    public Vector queryOwner() throws Exception {
        ...
        qry_seq = "F" + qry_date_start + qry_time_start;
        this.setQry_seq(qry_seq);
        con = "地籍總歸戶清冊(土地所有權人管理者)";
