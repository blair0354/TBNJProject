...
public class SQLReportEnvironment extends ReportEnvironment {
	...
	public String getDataSourceSQL(){
		return (String)this.get(ENV_DATASOURCE_SQL);
	}
	
	public void setDataSourceSQL(String sql){
		this.put(ENV_DATASOURCE_SQL,sql);
	}
	
	
	public Connection getConnection(){
		return (Connection)this.get(ENV_CONNECTION);
	}
	
	public void setConnection(Connection conn){
		this.put(ENV_CONNECTION,conn);
	}
